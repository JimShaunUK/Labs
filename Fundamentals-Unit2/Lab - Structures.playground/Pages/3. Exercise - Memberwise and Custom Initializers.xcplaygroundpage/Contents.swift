...
var favouriteBook = Book(author: "Dumas", title: "Monte Cristo", pages: 800, price: 2.99)
print(favouriteBook)
...
var someonesHeight = Height(heightInInches: 6.0)
...
var myHeight = Height(heightInCentimeters: 174.4)
print(myHeight)
